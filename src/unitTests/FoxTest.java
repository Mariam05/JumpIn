...
public class FoxTest {
	...
	/*
	 * testing the constructor by  checking if it has the correct name or not
	 * by using toString,
	 * and checking if it created an associated piece. 
	 */
	@Test
	public void ConstructorTest() {
		assertEquals(fox1.toString(),"F1");
		assertTrue(fox1.getAssociatedPart() != null);
		assertEquals(fox2.toString(),"F2");
		assertTrue(fox2.getAssociatedPart() != null);
	}
	/*
	...
	public void getAssociatedPartTest() {
		foxH = new Fox("F1T", FoxType.HORIZONTAL,false);
		foxY = new Fox("F"+fox2.toString().charAt(1)+ "T", FoxType.VERTICAL,false);
		fox1.getAssociatedPart().setPosition(0, 0);
		fox2.getAssociatedPart().setPosition(0, 0);
